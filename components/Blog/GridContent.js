          ...
          >
            <div className="pagination-area">
              <div className="nav-links">
                <Link href="/blogs/blog-grid" className="prev page-numbers">
                  prev
                </Link>
                <span className="page-numbers current">1</span>
                <Link href="/blogs/blog-grid" className="page-numbers">
                  2
                </Link>
                <Link href="/blogs/blog-grid" className="page-numbers">
                  3
                </Link>
                <Link href="/blogs/blog-grid" className="next page-numbers">
                  next
                </Link>
              </div>
            </div>
