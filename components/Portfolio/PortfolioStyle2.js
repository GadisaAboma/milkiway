          ...
          >
            <div className="pagination-area">
              <div className="nav-links">
                <Link href="/portfolio/portfolio-2" className="prev page-numbers">
                  prev
                </Link>
                <span className="page-numbers current">1</span>
                <Link href="/portfolio/portfolio-2" className="page-numbers">
                  2
                </Link>
                <Link href="/portfolio/portfolio-2" className="page-numbers">
                  3
                </Link>
                <Link href="/portfolio/portfolio-2" className="next page-numbers">
                  next
                </Link>
              </div>
            </div>
